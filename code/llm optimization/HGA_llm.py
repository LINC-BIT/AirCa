...
def main():
    ...
    system_content = (
        ...
        "You have detailed knowledge about Boeing 777 cargo compartment layout, containing 44 cargo positions. "
    ...
    user_content = (
        ...
        "If you have any additional suggestions to improve cargo loading, share them as well."
    )
