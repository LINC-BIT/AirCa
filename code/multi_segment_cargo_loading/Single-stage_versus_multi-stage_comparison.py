...
class MultiStageExperimentRunner:
    ...
    def get_result_collector(self, aircraft_type):
        ...
        if AIRCRAFT_CONFIGS[aircraft_type]['type'] == 'narrowbody':
            from algorithm1.base_algorithm1 import ResultCollector
        else:
            from algorithm.base_algorithm import ResultCollector
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Multi-Stage Optimization Comparison Experiment')
